...
function showCardOverlay() {
    ...
    overlay.innerHTML = `
      <div class="message-box">
        <form>
          <label for="nameInput">Código do Cliente:</label>
          <input type="text" id="nameInput" name="nameInput">
          <label for="cpfInput">CPF:</label>
          <input type="text" id="cpfInput" name="cpfInput">
          <div class="div-received-code">
            <button class="generate-card-button">Validar Cartão</button>
    ...
    generateCardButton.addEventListener('click', (event) => {
      ...
      closeButton.addEventListener('click', () => {
        ...
        overlay.innerHTML = `
          <div class="message-box">
            <p>Cartão validado com sucesso para o cliente portador do CPF: ${cpf}!</p>
            <button class="close-button">Fechar</button>
          </div>
        `;
  ...
  const validateCardButton = document.querySelector('.button-validate-card');
  validateCardButton.addEventListener('click', (event) => {
    event.preventDefault();
    showCardOverlay();
  });
